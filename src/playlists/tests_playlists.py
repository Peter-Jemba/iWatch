...
class PlaylistModelTestCase(TestCase):
    ...
    def create_videos(self):
        self.video_a = Video.objects.create(title='My title', video_id='abc123')
        self.video_b = Video.objects.create(title='My title', video_id='abc1233')
    ...
    def test_video_playlist_ids_propery(self):
        ...
        acutal_ids = list(Playlist.objects.filter(
